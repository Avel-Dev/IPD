    ...
    <nav className="sticky top-0 z-10 border-b border-white/10 bg-zinc-950/80 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-5xl items-center gap-6 px-4">
        <div className="font-semibold tracking-tight text-white">
          <Link to="/">Minimal DApp</Link>
        </div>
        
        {walletAddress && (
          <div className="flex gap-4 text-sm font-medium text-zinc-400 mr-auto">
            <Link to="/dashboard" className="hover:text-white transition-colors">Dashboard</Link>
            <Link to="/surplus-settings" className="hover:text-white transition-colors">Surplus Settings</Link>
          </div>
        )}
